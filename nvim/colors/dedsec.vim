...
hi Error          	guifg=#0A0C09	guibg=NONE	guisp=#F6335B	gui=underline	ctermfg=0	ctermbg=NONE	cterm=underline
hi ErrorMsg		guifg=#0A0C09	guibg=NONE	guisp=#F6335B	gui=underline	ctermfg=0	ctermbg=NONE	cterm=underline
...
hi Keyword        	guifg=#00F528	guibg=NONE	guisp=NONE	gui=bold	ctermfg=10	ctermbg=NONE	cterm=bold
...
hi ModeMsg		guifg=#F9F9F9	guibg=#0A0C09	guisp=NONE	gui=bold	ctermfg=15	ctermbg=0	cterm=bold
